...
function ItemDetail({ products }) {
  ...
  return (
    ...
    <div className="text">
      ...
      {stock == 0 ? <button className="btn btn-secondary">No disponible</button>:<button onClick={ ()=> addToCart(products) } type="submit" className="btn btn-success">Comprar</button> }
    </div>
  </div> 
  </>
  );
